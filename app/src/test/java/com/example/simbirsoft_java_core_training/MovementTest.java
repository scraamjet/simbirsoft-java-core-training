...
public class MovementTest {
    ...
    public void testMoveUp() {
        int[] result = Movement.move(0, 0, Movement.Directions.UP);
        assertArrayEquals(new int[]{0, 1}, result);
    }

    @Test
    public void testMoveDown() {
        int[] result = Movement.move(0, 0, Movement.Directions.DOWN);
        assertArrayEquals(new int[]{0, -1}, result);
    }

    @Test
    public void testMoveLeft() {
        int[] result = Movement.move(0, 0, Movement.Directions.LEFT);
        assertArrayEquals(new int[]{-1, 0}, result);
    }

    @Test
    public void testMoveRight() {
        int[] result = Movement.move(0, 0, Movement.Directions.RIGHT);
        assertArrayEquals(new int[]{1, 0}, result);
    }
